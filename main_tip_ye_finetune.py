...
from upt_tip_cache_model_free_ye_finetune import build_detector

from utils_tip_cache_and_union_ye_finetune import custom_collate, CustomisedDLE, DataFactory
import pdb, json
...
def main(rank, args):
    ...
    trainset = DataFactory(name=args.dataset, partition=args.partitions[0], data_root=args.data_root, few_shot_pickle=args.few_shot_pickle)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--few_shot_pickle', default='/work/yangl/hoi/leiting/upt_train_free/few_shot_pickle/yzj/few_shot_2_1153_844_annofile.p', type=str)

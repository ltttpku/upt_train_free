...
class DataFactory(Dataset):
    def __init__(self, name, partition, data_root):
        ...
        device = "cuda"
        _, self.process = clip.load('ViT-B/32', device=device)
    def __len__(self):
...
class CustomisedDLE(DistributedLearningEngine):
    ...
    def test_hico(self, dataloader):
        ...
        pdb.set_trace()
        print("pair:",net.module.r1_pair/net.module.count_pair)
        print("no pair:",net.module.r1_nopair/net.module.count_nopair)
